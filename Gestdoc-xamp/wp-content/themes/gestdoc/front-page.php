    ...
    <div id="sections">
        ...
        <div class="section__primary">
          <div class="section__wrap section__wrap--main">
            <div class="section__body dscroll">
              ...
              <p class="section__description"><?php the_field('subtitulo_principal')?></p><a href="<?php echo site_url( '/docs/' ); ?>" class="btn"><?php the_field('boton_principal')?></a>
              <!--.section__search
      ...
      <section class="section--features">
        <div class="section__wrap">
          ...
          <a href="<?php echo site_url( '/Personas/' ); ?>" class="btn"><?php the_field('boton_bloque_informativo')?><span class="fa fa-external-link"></span></a>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="cols">	
            <div class="col-md-6 dscroll">
              <div class="section__body"> 
                ...
                <p class="section__content"><?php the_field('parrafo_modulo_empresas')?></p><a href="<?php echo site_url( '/Empresas/' ); ?>" class="btn"><?php the_field('botono_modulo_empresas')?></a>
              </div>
            </div>
            <div class="col-md-6 dscroll">
              ...
              <div class="section__faq"> 
                ...
                <div class="section__faq">
                            <div class="faq">
                                ...
                                ?>
                                <div class="faq__item">
                                    <h3 class="faq__question"><span class="fa fa-angle-down"></span><?php echo $caja['pregunta']; ?></h3>
                                    <div class="faq__answer">
                                        <div class="section__content">
